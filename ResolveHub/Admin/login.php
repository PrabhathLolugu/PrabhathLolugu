...
if(!isset($_SESSION['is_adminlogin'])){
  if(isset($_REQUEST['aEmail'])){
    ...
    $sql = "SELECT a_email, a_passwprd FROM adminlogin_tb WHERE a_email='".$aEmail."' AND a_passwprd='".$aPassword."' limit 1";
...
<body>
  ...
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span>
      Admin Login</span>
  </p>
